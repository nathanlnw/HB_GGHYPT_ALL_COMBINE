...
u8		RemoteIP_main[4]={113,31,28,101};//{125,38,185,88};//{113,31,28,101 };//{113,31,92,200};//天津{60,28,50,210}; 河北天地通 113,31,28,100                        
u16		RemotePort_main= 8201;//天津9131;   河北天地通 8201             //test tianjin     
u8		RemoteIP_aux[4]={113,31,28,100};    //{60,28,50,210}
...
void  Vehicleinfo_Init(void) 
{
	...
	memcpy(Vechicle_Info.Vech_Num,"冀A00000",8);        
